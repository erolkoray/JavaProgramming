...
public class ScrumTeam {
    ...
    public void addTesters(Tester[] testers){ // because the local variable testers here has the same name of the instance variable means we have to use this. keyword so compiler knows that we are adding the all the testers to instance variable arraylist testers
