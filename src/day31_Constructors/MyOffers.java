...
public class MyOffers {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("fulltime offers: "+fullTimeOffers.size());
        ...
        offersWithBenefits.removeIf(p -> !p.hasBenefits);
        ...
        ArrayList<Offer> offersOver100K = new ArrayList<>(Arrays.asList(myOffers));
        offersOver100K.removeIf(p -> p.salary < 100000);
        System.out.println("salary over 100k: "+offersOver100K.size());
