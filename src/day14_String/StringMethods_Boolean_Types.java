...
public class StringMethods_Boolean_Types {

    public static void main(String[] args) {

        // IS EMPTY() METHOD - will only return true if string is completely blank (empty) not even a space
        ...
        // IS BLANK() METHOD - will only return true if there is only white spaces in the string (no other character but space)
...
// Yes, YES, yEs, yES, YEs...
        ...
        // IN EQUALS THERE IS A CASE IGNORE METHODS, SO NO NEED TO USE LOWER/UPPER CASE METHODS
